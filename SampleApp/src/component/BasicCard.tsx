...
export const BasicCard = (props: CardProps) => {
    ...
    return (
        <TouchableOpacity
            ...
            onPress={() => {
                MoEngageLogger.debug("Card Clicked", props.card);
            ...
            <TouchableOpacity
                onLongPress={() => onLongPress(props.card, props.onDelete)}
                onPress={() => {
                    MoEngageLogger.debug("Image Clicked", imageWidget);
            ...
            <View style={styles.textSection}>
                {headerWidget != null
                    && (
                        <TouchableOpacity
                            onPress={() => {
                                MoEngageLogger.debug("Header Clicked", headerWidget);
                ...
                {messageWidget != null
                    && (
                        <TouchableOpacity
                            onPress={() => {
                                MoEngageLogger.debug("Message Clicked", messageWidget);
