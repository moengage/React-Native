...
// using ReactNativeMoEngageInbox.podspec — this file is only consumed by
// React Native's SPM autolinker.
//
// The autolinker references this package through a symlink at
// <app>/build/generated/autolinking/libs/ReactNativeMoEngageInbox, so the
...
// look it up as "ReactNativeMoEngageInbox" rather than the name it would otherwise derive.

import PackageDescription

let package = Package(
    name: "ReactNativeMoEngageInbox",
    ...
    platforms: [.iOS(.v15)],
    products: [
        .library(name: "ReactNativeMoEngageInbox", targets: ["ReactNativeMoEngageInbox"]),
    ],
    dependencies: [
    ...
    targets: [
        .target(
            ...
            path: "ios",
            exclude: ["MoEReactInbox.xcodeproj"],
