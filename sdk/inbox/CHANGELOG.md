...
- iOS
  ...
  - [major] Updated `MoEngageInbox` to `3.04.0`
...
- iOS
  - updating `MoEngagePluginInbox` to `4.10.0`
...
- Android - `inbox-core` version updated to `3.1.0` - Added support for AGP `8.4.0` and above - Kotlin version updated to `1.9.23` - Compile SDK version updated to `34`
  -iOS - `MoEngageInbox` version updated to `~>2.17.0`

# 03-07-2024

## 4.0.2

- Android - `inbox-core` version updated to `3.0.2`
  -iOS - `MoEngageInbox` version updated to `~>2.16.0`
