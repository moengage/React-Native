...
// using ReactNativeMoEngageCards.podspec — this file is only consumed by
// React Native's SPM autolinker.
//
// The autolinker references this package through a symlink at
// <app>/build/generated/autolinking/libs/ReactNativeMoEngageCards, so the
...
// look it up as "ReactNativeMoEngageCards" rather than the name it would otherwise derive.

import PackageDescription

let package = Package(
    name: "ReactNativeMoEngageCards",
    ...
    platforms: [.iOS(.v15)],
    products: [
        .library(name: "ReactNativeMoEngageCards", targets: ["ReactNativeMoEngageCards"]),
    ],
    dependencies: [
    ...
    targets: [
        .target(
            ...
            path: "ios",
            exclude: ["Cards.xcodeproj", "Cards.xcworkspace"],
